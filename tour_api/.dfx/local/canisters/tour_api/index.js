...
import { idlFactory } from './tour_api.did.js';
export { idlFactory } from './tour_api.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.TOUR_API_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./tour_api.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the tour_api canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./tour_api.did.js")._SERVICE>}
 */
export const tour_api = createActor(canisterId);
